...
#define GPIO_NODE DT_NODELABEL(lcdin)
...
int lcdInit(void)
{
	...
	GPIO_PIN_CFG(gpio_dev, GPIO_PIN_PC24_BL, GPIO_OUTPUT);
	GPIO_PIN_WR(gpio_dev, GPIO_PIN_PC24_BL, HIGH);
	...
	while (1) {
		...
		pi_lcd_string(gpio_dev, "hi Bram");
